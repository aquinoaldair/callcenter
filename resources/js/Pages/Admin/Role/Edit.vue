<template>
    <admin-layout>
        <breadcrumb title="Editar Rol de Usuario" />
        <div class="row">
            <div class="col-lg-12">
                <div class="card">
                    <div class="card-body">
...
export default {
    ...
    created() {
        ...
        this.permissions.forEach( (item) => {
            item.selected = !!this.role.permissions.find(element => item.name == element.name);
        });
    },
    methods: {
        save(){
            ...
            this.$inertia.post(this.route('role.update', this.role), this.form);
        },
